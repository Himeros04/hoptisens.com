          ...
          <FadeInUp className="text-white">
            ...
            <ul className="space-y-4 mb-8 text-white/80 max-w-lg">
              <li className="flex items-start gap-3">
                ...
                <div><span className="font-semibold text-white">Étape 1 - Le Diagnostic (Offert)</span> : Remplissez notre questionnaire ciblé. Notre IA analyse vos données réelles pour évaluer la faisabilité et votre ROI potentiel.</div>
              </li>
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                <span className="text-lg">🛡️</span>
                <div><span className="font-semibold text-white">Garantie Confiance</span> : L'étape 1 filtre les idées irréalisables pour vous faire gagner du temps. L'étape 2 sécurise juridiquement et techniquement vos investissements.</div>
              </li>
            </ul>
            <div className="flex gap-4">
              <Link href="/diagnostic" className="inline-block">
          ...
          <FadeInUp className="order-first lg:order-last">
            ...
            <div className="aspect-square relative flex items-center justify-center p-8 bg-white/5 rounded-3xl border border-white/10">
              ...
              <div className="relative text-center">
                ...
                <div className="text-white/70 uppercase tracking-widest text-sm">Jours pour prouver que ça marche</div>
              </div>
            </div>
          </FadeInUp>
        </div>
